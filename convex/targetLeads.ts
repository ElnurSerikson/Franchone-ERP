...
async function collect(
  ...
  // Объект попадает в аналитику, если у него есть план, заявки или расход.
  const ids = new Set<string>([
    ...planLeadsByObject.keys(),
    ...factLeadsByObject.keys(),
    ...factBudgetByObject.keys(),
  ])
