...
type TaskStatus = 'backlog' | 'progress' | 'review' | 'done'
...
const TASKS: Array<{ title: string; description?: string; status: TaskStatus; priority: Priority; assignee: string; reporter: string; deadline: string; tags: string[]; checklist: Array<{ text: string; done: boolean }>; attachments: number; comments: number; kpiRef?: string }> = [
  { title: 'Снять 4 Reels для аккаунта ANUAR', description: 'Съёмка и монтаж 4 роликов по контент-плану на неделю.', status: 'progress', priority: 'high', assignee: 'u2', reporter: 'u1', deadline: '2026-07-22', tags: ['SMM', 'Контент'], checklist: [{ text: 'Написать сценарии', done: true }, { text: 'Съёмка', done: true }, { text: 'Монтаж', done: false }, { text: 'Публикация', done: false }], attachments: 2, comments: 3, kpiRef: 'ANUAR · Рилсы' },
  { title: 'Перезапустить кампанию «Брокеридж»', description: 'CPL выше плана, обновить креативы и аудитории.', status: 'progress', priority: 'urgent', assignee: 'u3', reporter: 'u1', deadline: '2026-07-20', tags: ['Таргет', 'FR-002'], checklist: [{ text: 'Новые креативы (3 шт.)', done: true }, { text: 'Настроить аудитории', done: false }, { text: 'Запуск A/B', done: false }], attachments: 1, comments: 5, kpiRef: 'Кампания FR-002' },
  { title: 'Упаковка GREEK FOOD — операционный блок', description: 'Чек-листы открытия, бизнес-процессы, аудиторский регламент.', status: 'review', priority: 'medium', assignee: 'u5', reporter: 'u4', deadline: '2026-07-25', tags: ['Упаковка', 'Проект'], checklist: [{ text: 'Чек-лист открытия', done: true }, { text: 'Бизнес-процессы', done: true }, { text: 'Аудиторский регламент', done: false }], attachments: 6, comments: 2 },
  { title: 'Обзвонить заявки по «Упаковке франшизы»', description: '22 новых заявки с прошлой недели.', status: 'backlog', priority: 'high', assignee: 'u4', reporter: 'u1', deadline: '2026-07-21', tags: ['Продажи'], checklist: [], attachments: 0, comments: 0 },
  { title: 'Подготовить 24 сторис FRANCHONE на неделю', status: 'backlog', priority: 'medium', assignee: 'u2', reporter: 'u1', deadline: '2026-07-23', tags: ['SMM', 'Контент'], checklist: [], attachments: 0, comments: 1, kpiRef: 'FRANCHONE · Сторис' },
  { title: 'Свести отчёт по CPL за июль', status: 'backlog', priority: 'low', assignee: 'u3', reporter: 'u4', deadline: '2026-07-31', tags: ['Таргет', 'Отчёт'], checklist: [], attachments: 0, comments: 0 },
  ...
  { title: 'Карусель «5 мифов о франчайзинге»', status: 'review', priority: 'medium', assignee: 'u2', reporter: 'u1', deadline: '2026-07-17', tags: ['SMM', 'Контент'], checklist: [{ text: 'Дизайн 8 слайдов', done: true }], attachments: 1, comments: 2, kpiRef: 'FRANCHONE · Карусели' },
]
