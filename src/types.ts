...
// 'client' — заказчик упаковки франшизы (ТЗ Упаковка §3). В команде он не
// состоит и ни одного раздела ERP не видит: приложение подменяет ему всю
// оболочку на кабинет клиента.
export type Role = 'owner' | 'head' | 'employee' | 'client'
